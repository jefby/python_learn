...
class _ConnectionCtx(object):
    '''
    _ConnectionCtx object can open and close connection context,_ConnectionCtx object can be nested and only
...
def connection():
    '''
    Return _ConnectionCtx object that be used by 'with' statement
